...
export interface DemographicCounts {
  ...
  // is the number of people in that group
...
export type VotingMetricsList = readonly (readonly [
  string,
  VotingMetricField
])[];
...
export type CreateProjectTemplateData = Pick<
  IProjectTemplate,
  "description" | "details"
> & {
  readonly project: Pick<IProject, "id">;
...
export type DistrictsImportApiResponse =
  | DistrictsImportApiSuccess
  | DistrictsImportApiError;
