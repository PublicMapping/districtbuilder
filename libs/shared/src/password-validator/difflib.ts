...
// Modified version of https://github.com/qiao/difflib.js/blob/master/lib/difflib.js
// Licensed under the 'Python Software Foundation' license agreement for Python 2.7.2
...
SequenceMatcher = (function () {
  /*
      ...
      sequences.  As a rule of thumb, a .ratio() over 0.6 means the
  ...
  SequenceMatcher.prototype.ratio = function () {
    ...
    let match, matches, _i, _len, _ref;
    matches = 0;
    _ref = this.getMatchingBlocks();
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      match = _ref[_i];
  ...
  SequenceMatcher.prototype.quickRatio = function () {
    ...
    let avail, elt, fullbcount, matches, numb, _i, _j, _len, _len1, _ref, _ref1;
    if (!this.fullbcount) {
  ...
  Differ.prototype._fancyReplace = function (a, alo, ahi, b, blo, bhi) {
    ...
    for (
      ...
      for (
        ...
        cruncher.setSeq1(ai);
        if (
          cruncher.realQuickRatio() > bestRatio &&
...
restore = function (delta, which) {
  ...
  let line, lines, prefixes, tag, _i, _len, _ref;
  tag = {
    1: "- ",
    2: "+ ",
  }[which];
