...
resource "aws_lambda_function" "alert_database_server_alarms" {
  filename         = "${path.module}/lambda-functions/alert_db/alert_db.zip"
  source_code_hash = base64sha256(filebase64("${path.module}/lambda-functions/alert_db/alert_db.zip"))
