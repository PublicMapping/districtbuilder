...
const OrganizationWithTemplates = ({
  organizations,
  onTemplateChanged,
  orgChanged
}: Props & IProps) => {
  const onOrgChanged = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const org =
      ...
      organizations?.filter(o => o.slug === e.currentTarget.value)[0];
  ...
  return (
    <React.Fragment sx={style.container}>
...
export default OrganizationWithTemplates;
