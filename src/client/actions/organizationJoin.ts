...
export const joinOrganizationSuccess = createAction("Join organization success")<
  OrganizationSlug
>();
...
export const leaveOrganizationSuccess = createAction("Leave organization success")<
  OrganizationSlug
>();
