...
export class CreateProject1587590245115 implements MigrationInterface {
    name = 'CreateProject1587590245115'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "number_of_districts" integer NOT NULL, "created_dt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(), "region_config_id" uuid, "user_id" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`, undefined);
