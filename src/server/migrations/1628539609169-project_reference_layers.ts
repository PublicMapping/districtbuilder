...
export class projectReferenceLayers1628539609169 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "project"."pinned_metric_fields" IS NULL`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "project_template"."pinned_metric_fields" IS NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "project_template" ALTER COLUMN "pinned_metric_fields" SET DEFAULT ARRAY['population'`);
        await queryRunner.query(`COMMENT ON COLUMN "project_template"."pinned_metric_fields" IS NULL`);
        await queryRunner.query(`ALTER TABLE "project" ALTER COLUMN "pinned_metric_fields" SET DEFAULT ARRAY['population'`);
        await queryRunner.query(`COMMENT ON COLUMN "project"."pinned_metric_fields" IS NULL`);
