...
} from "@districtbuilder/shared/constants";
import {
  DistrictsDefinition,
  ProjectId,
...
import { Errors } from "@districtbuilder/shared/types";
import axios from "axios";
import { Brackets } from "typeorm";
import {
  getDemographicsMetricFields,
  getVotingMetricFields
} from "@districtbuilder/shared/functions";
...
export class ProjectsController implements CrudController<Project> {
  ...
  async updateOne(
    ...
    // Update districts GeoJSON if the definition has changed, the version is out-of-date, or there is no cached yet
